...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['password2'].widget.attrs['placeholder']='reenter the password'
...
class AddCustomer(forms.ModelForm):
    ...
    phone=forms.CharField(required=True,max_length=40,label="",widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Phone number'}))
    ...
    state=forms.CharField(required=True,max_length=60,label="",widget=forms.TextInput(attrs={'class':'form-control','placeholder':'State'}))
    zipcode=forms.CharField(required=True,max_length=30,label="",widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Zipcode'}))
